...
Процедура ЗаписатьДвиженияРегистратора(Регистратор, Данные, МетаданныеРегистра, ПараметрыЗаписи, ОбщиеРеквизиты = Неопределено) Экспорт
	...
	СодержитПериод = Не ЮТМетаданные.ЭтоРегистрРасчета(МетаданныеРегистра);
	...
	Для Каждого Строка Из Данные Цикл
		...
		Если СодержитПериод И НЕ ЗначениеЗаполнено(Запись.Период) Тогда
...
Процедура ЗаполнитьБазовыеРеквизиты(Объект, ОписаниеОбъектаМетаданных)
	...
	УстановитьНовуюДатуИНомер = ЮТМетаданные.ЭтоДокумент(ОписаниеОбъектаМетаданных)
		Или ЮТМетаданные.ЭтоБизнесПроцесс(ОписаниеОбъектаМетаданных)
		Или ЮТМетаданные.ЭтоЗадача(ОписаниеОбъектаМетаданных);
	
	УстановитьНовуюДату = УстановитьНовуюДатуИНомер И НЕ ЗначениеЗаполнено(Объект.Дата);
	УстановитьНовыйНомер = УстановитьНовуюДатуИНомер И НЕ ЗначениеЗаполнено(Объект.Номер);
	...
	Если УстановитьНовуюДату Тогда
