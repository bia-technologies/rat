...
Функция ПредставлениеСериализованногоЗначения(СериализованноеЗначение, ЭтоСоставнойРеквизит)
	...
	Если РатТипыДанных.ЭтоСтруктура(СериализованноеЗначение) Тогда
		...
		ПредставлениеЗначения = ПредставлениеЗначенияСценария(СыройРезультат);
		
		Если ЭтоСоставнойРеквизит Тогда
			Возврат СтрШаблон("'%1.%2'", ТипЗначения, ПредставлениеЗначения);
		Иначе
...
Функция ПредставлениеПримитива(Значение)
	...
	Тип = ТипЗнч(Значение);
	Представление = ПредставлениеЗначенияСценария(Значение);
...
&НаСервереБезКонтекста
Функция ПредставлениеЗначенияСценария(Значение)
