...
&НаКлиенте
Процедура ЯВыполняюАлгоритмВКлиентеТестирования(ТекстАлгоритма) Экспорт

	Команда = РатВзаимодействиеСКлиентомТестирования.НоваяКоманда();
	Команда.Метод = "РатВзаимодействиеСКлиентомТестированияКлиент.ВыполнитьАлгоритм";
	Команда.Параметры.Добавить(ТекстАлгоритма);
...
&НаКлиенте
Процедура ЯВыполняюАлгоритмВКлиентеТестированияНаСервере(ТекстАлгоритма) Экспорт

	Команда = РатВзаимодействиеСКлиентомТестирования.НоваяКоманда();
	Команда.Метод = "РатВзаимодействиеСКлиентомТестированияКлиент.ВыполнитьАлгоритмНаСервере";
	Команда.Параметры.Добавить(ТекстАлгоритма);
