...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	// регистр Ф_ОстаткиТоваров
	Движения.Ф_ОстаткиТоваров.Записывать = Истина;
	Для Каждого ТекСтрокаТоварыУслуги Из ТоварыУслуги Цикл
		Движение = Движения.Ф_ОстаткиТоваров.Добавить();
	...
	Движения.Ф_ОстаткиТоваров.Записать(Истина);
	//}}__КОНСТРУКТОР_ДВИЖЕНИЙ_РЕГИСТРОВ
КонецПроцедуры
