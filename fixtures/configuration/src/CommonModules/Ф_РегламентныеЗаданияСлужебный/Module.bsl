...
Процедура Пауза(Секунд = 10) Экспорт
	...
	Если ФоновоеЗадание = Неопределено Тогда
		...
		ФоновоеЗадание = ФоновыеЗадания.Выполнить("Ф_РегламентныеЗаданияСлужебный.Пауза", Параметры); // Тут указываем имя общего модуля, в котором лежит данная процедура
	КонецЕсли;
